...
class AttributeInfo(metaclass=ABCMeta):
    ...
    def newAttributeInfo(attrName, attrLen, constantPool):
        ...
        from ch06.classfile.AttrMarkers import DeprecatedAttribute, SyntheticAttribute
        from ch06.classfile.AttrExceptions import ExceptionsAttribute
        from ch06.classfile.AttrLineNumberTable import LineNumberTableAttribute
        from ch06.classfile.AttrSourceFile import SourceFileAttribute
        from ch06.classfile.AttrUnparsed import UnparsedAttribute
        from ch06.classfile.AttrLocalVariableTable import LocalVariableTableAttribute
