...
class AttributeInfo(metaclass=ABCMeta):
    ...
    def newAttributeInfo(attrName, attrLen, constantPool):
        from ch03.classfile.AttrCode import CodeAttribute
        from ch03.classfile.AttrConstantValue import ConstantValueAttribute
        from ch03.classfile.AttrMarkers import DeprecatedAttribute, SyntheticAttribute
        from ch03.classfile.AttrExceptions import ExceptionsAttribute
        from ch03.classfile.AttrLineNumberTable import LineNumberTableAttribute
        from ch03.classfile.AttrSourceFile import SourceFileAttribute
        from ch03.classfile.AttrUnparsed import UnparsedAttribute
        from ch03.classfile.AttrLocalVariableTable import LocalVariableTableAttribute
