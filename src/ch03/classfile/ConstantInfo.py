...
class ConstantInfo(metaclass=ABCMeta):
    ...
    def newConstatnInfo(tag, constantPool):
        from ch03.classfile.CpNumeric import ConstantDoubleInfo, ConstantLongInfo, ConstantFloatInfo, ConstantIntgerInfo
        from ch03.classfile.ConstantUtf8Info import ConstantUtf8Info
        from ch03.classfile.ConstantStringInfo import ConstantStringInfo
        from ch03.classfile.ConstantMemberrefInfo import ConstantFieldrefInfo, ConstantInterfaceMethodrefInfo, \
            ConstantMethodrefInfo
        from ch03.classfile.ConstantNameAndTypeInfo import ConstantNameAndTypeInfo
        from ch03.classfile.ConstantClassInfo import ConstantClassInfo
        from ch03.classfile.CpInvokeDynamic import ConstantInvokeDynamicInfo, ConstantMethodHandleInfo, \
