...
class ConstantInfo(metaclass=ABCMeta):
    ...
    def new_constant_info(tag, constant_pool):
        from ch07.classfile.CpNumeric import ConstantDoubleInfo, ConstantLongInfo, ConstantFloatInfo, ConstantIntegerInfo
        from ch07.classfile.ConstantUtf8Info import ConstantUtf8Info
        from ch07.classfile.ConstantStringInfo import ConstantStringInfo
        from ch07.classfile.ConstantMemberRefInfo import ConstantFieldRefInfo, ConstantInterfaceMethodRefInfo, \
            ConstantMethodRefInfo
        from ch07.classfile.ConstantNameAndTypeInfo import ConstantNameAndTypeInfo
        from ch07.classfile.ConstantClassInfo import ConstantClassInfo
        from ch07.classfile.CpInvokeDynamic import ConstantInvokeDynamicInfo, ConstantMethodHandleInfo, \
