...
class AttributeInfo(metaclass=ABCMeta):
    ...
    def newAttributeInfo(attrName, attrLen, constantPool):
        from ch07.classfile.AttrCode import CodeAttribute
        from ch07.classfile.AttrConstantValue import ConstantValueAttribute
        from ch07.classfile.AttrMarkers import DeprecatedAttribute, SyntheticAttribute
        from ch07.classfile.AttrExceptions import ExceptionsAttribute
        from ch07.classfile.AttrLineNumberTable import LineNumberTableAttribute
        from ch07.classfile.AttrSourceFile import SourceFileAttribute
        from ch07.classfile.AttrUnparsed import UnparsedAttribute
        from ch07.classfile.AttrLocalVariableTable import LocalVariableTableAttribute
