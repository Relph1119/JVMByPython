...
class AttributeInfo(metaclass=ABCMeta):
    ...
    def newAttributeInfo(attrName, attrLen, constantPool):
        from ch08.classfile.AttrCode import CodeAttribute
        from ch08.classfile.AttrConstantValue import ConstantValueAttribute
        from ch08.classfile.AttrMarkers import DeprecatedAttribute, SyntheticAttribute
        from ch08.classfile.AttrExceptions import ExceptionsAttribute
        from ch08.classfile.AttrLineNumberTable import LineNumberTableAttribute
        from ch08.classfile.AttrSourceFile import SourceFileAttribute
        from ch08.classfile.AttrUnparsed import UnparsedAttribute
        from ch08.classfile.AttrLocalVariableTable import LocalVariableTableAttribute
