...
class ConstantPool():
    ...
    def newConstantPool(clazz, cfConstantPool):
        from ch08.classfile.CpNumeric import ConstantDoubleInfo, ConstantLongInfo, ConstantFloatInfo, ConstantIntgerInfo
        ...
        from ch08.classfile.ConstantMemberrefInfo import ConstantFieldrefInfo, ConstantMethodrefInfo, ConstantInterfaceMethodrefInfo
