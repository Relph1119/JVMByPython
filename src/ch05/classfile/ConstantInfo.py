...
class ConstantInfo(metaclass=ABCMeta):
    ...
    def newConstatnInfo(tag, constantPool):
        from ch05.classfile.CpNumeric import ConstantDoubleInfo, ConstantLongInfo, ConstantFloatInfo, ConstantIntgerInfo
        from ch05.classfile.ConstantUtf8Info import ConstantUtf8Info
        from ch05.classfile.ConstantStringInfo import ConstantStringInfo
        from ch05.classfile.ConstantMemberrefInfo import ConstantFieldrefInfo, ConstantInterfaceMethodrefInfo, \
            ConstantMethodrefInfo
        from ch05.classfile.ConstantNameAndTypeInfo import ConstantNameAndTypeInfo
        from ch05.classfile.ConstantClassInfo import ConstantClassInfo
        from ch05.classfile.CpInvokeDynamic import ConstantInvokeDynamicInfo, ConstantMethodHandleInfo, \
